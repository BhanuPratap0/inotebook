  ...
  return (
    <>
      <div className='about-container' >
        <div className='sections' style={{backgroundColor:"white"}} ><h1><b>About iNoteBook</b></h1>
        <hr></hr>
        <br/>
        ...
        <hr></hr>
        <br/>
        <p>At iNoteBook, we believe in empowering users with a simple and secure platform to capture and manage their ideas effortlessly. We understand the importance of privacy and strive to provide you with a reliable space where you can create, update, and delete your notes with confidence.</p>
